...
import { MealAddProps } from "./meal-create";

export async function mealEdit(mealData: MealAddProps, id: string): Promise<void> {

  try {
    mealValidate(mealData);
    ...
    const updatedMeals = [...filteredMeals, meal];
